...
def insert_max_category_in(max_category, start_row, worksheet):
    ...
    worksheet.insert_row(["Category with Max Expense", max_category], start_row)
    time.sleep(2)

def insert_biggestTs_in(start_row, worksheet):
    # Insert the header for the biggest transactions section
    worksheet.insert_row(["Biggest Transaction in Each Month", "", "", "", ""], start_row + 2)
...
def insert_net_amounts_in(start_row, worksheet):
    ...
    worksheet.insert_row(["Net Amounts", "", "", "", ""], start_row + 5)

    # Insert net amount credited and debited
    worksheet.insert_row(["Net Amount Credited", "", "", "", totAmtCD], start_row + 6)
    worksheet.insert_row(["Net Amount Debited", "", "", "", totAmtDD], start_row + 7)
